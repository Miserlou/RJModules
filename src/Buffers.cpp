...
BuffersWidget::BuffersWidget(Buffers *module) : ModuleWidget(module) {
    ...
    addParam(ParamWidget::create<RoundSmallBlackKnob>(mm2px(Vec(16.57, 17.165)), module, Buffers::MUTE_PARAM + 0, 0.0, 4.5, 0.0));
    addParam(ParamWidget::create<RoundSmallBlackKnob>(mm2px(Vec(16.57, 27.164)), module, Buffers::MUTE_PARAM + 1, 0.0, 4.5, 0.0));
    addParam(ParamWidget::create<RoundSmallBlackKnob>(mm2px(Vec(16.57, 37.164)), module, Buffers::MUTE_PARAM + 2, 0.0, 4.5, 0.0));
    addParam(ParamWidget::create<RoundSmallBlackKnob>(mm2px(Vec(16.57, 47.165)), module, Buffers::MUTE_PARAM + 3, 0.0, 4.5, 0.0));
    addParam(ParamWidget::create<RoundSmallBlackKnob>(mm2px(Vec(16.57, 57.164)), module, Buffers::MUTE_PARAM + 4, 0.0, 4.5, 0.0));
    addParam(ParamWidget::create<RoundSmallBlackKnob>(mm2px(Vec(16.57, 67.165)), module, Buffers::MUTE_PARAM + 5, 0.0, 4.5, 0.0));
    addParam(ParamWidget::create<RoundSmallBlackKnob>(mm2px(Vec(16.57, 77.164)), module, Buffers::MUTE_PARAM + 6, 0.0, 4.5, 0.0));
    addParam(ParamWidget::create<RoundSmallBlackKnob>(mm2px(Vec(16.57, 87.164)), module, Buffers::MUTE_PARAM + 7, 0.0, 4.5, 0.0));
    addParam(ParamWidget::create<RoundSmallBlackKnob>(mm2px(Vec(16.57, 97.165)), module, Buffers::MUTE_PARAM + 8, 0.0, 4.5, 0.0));
    addParam(ParamWidget::create<RoundSmallBlackKnob>(mm2px(Vec(16.57, 107.166)), module, Buffers::MUTE_PARAM + 9, 0.0, 4.5, 0.0));
