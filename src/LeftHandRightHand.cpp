...
struct LeftHandRightHandWidget : ModuleWidget {
    LeftHandRightHandWidget(LeftHandRightHand* module) {
        ...
        addOutput(createOutput<PJ301MPort>(mm2px(Vec(4.61505, 76.1449)), module, LeftHandRightHand::AFTERTOUCH_OUTPUT));
        addOutput(createOutput<PJ301MPort>(mm2px(Vec(16.214, 76.1449)), module, LeftHandRightHand::PITCH_OUTPUT));
        addOutput(createOutput<PJ301MPort>(mm2px(Vec(27.8143, 76.1449)), module, LeftHandRightHand::MOD_OUTPUT));
        ...
        addOutput(createOutput<PJ301MPort>(mm2px(Vec(4.61505, 108.144)), module, LeftHandRightHand::START_OUTPUT));
        addOutput(createOutput<PJ301MPort>(mm2px(Vec(16.214, 108.144)), module, LeftHandRightHand::STOP_OUTPUT));
        addOutput(createOutput<PJ301MPort>(mm2px(Vec(27.8143, 108.144)), module, LeftHandRightHand::CONTINUE_OUTPUT));
